...
<?
	$this->EndViewTarget();
	$APPLICATION->AddViewContent("section_description", $html);
}
//endregion
?>
...
<!-- items-container -->
<div class="catalog__goods-wrapper" data-entity="<?= $containerName ?>">
	<?
...
?>
	<div class="catalog__more" data-entity="lazy-<?= $containerName ?>">
		<a href="javascript:void(0);" class="catalog__more-btn link" data-use="show-more-<?= $navParams['NavNum'] ?>">
			<span class="icon-load"></span>Загрузить еще 12 товаров
		</a>
	</div>
<?
}
